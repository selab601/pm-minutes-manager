...
class MinutesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'holded_place' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => '', 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'holded_at' => '2016-10-02 12:26:32',
            'created_at' => '2016-10-02 12:26:32',
            'updated_at' => 1475378792,
            'revision' => 1,
            'is_examined' => 1,
            'is_approved' => 1,
            'examined_at' => '2016-10-02 12:26:32',
            'approved_at' => '2016-10-02 12:26:32',
            'examined_by' => 1,
            'approved_by' => 1,
            'examined_user_name' => 'Lorem ipsum dolor sit amet',
            'approved_user_name' => 'Lorem ipsum dolor sit amet',
            'is_deletable' => 1,
            'ended_at' => '2016-10-02 12:26:32'
        ],
    ];
}
